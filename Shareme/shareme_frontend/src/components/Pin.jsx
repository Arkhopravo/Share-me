    ...
    <div className='m-2'>
                ...
                {alreadySaved? (
                    ...
                    <div className='flex justify-between items-center gap-2 w-full'>
                        ...
                        {postedBy?._id=== user.googleId && (
                            ...
                            type='button' className='bg-white opacity-70 hover:opacity-100  font-bold text-dark px-5 py-1 text-base rounded-3xl hover: shadow-md outlined-none'
        ...
        <Link to={`user-profile/${postedBy?._id}`} className="flex gap-2 mt-2 items-center" >
            <img 
              ...
              alt="user-profile"
            />
            <p className='font-semibolb capitalize' >{postedBy?.userName}</p>
